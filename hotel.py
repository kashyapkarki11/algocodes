...
class Bill_App:
    def __init__(self, root):
        ...
        bg_color = '#675634'
        title = Label(self.root, text="BILL PAYMENT OF BANGABNG HOUSE ", bd=12, bg=bg_color, fg="blue",
                      font=("arial ", 30, "bold"), pady=2).pack(fill=X)
        # ================Variables==========================
        # ================Cosemetics==========================
        ...
        F1 = LabelFrame(self.root, bd=8, text="Customer Details", font=("arial", 15, "bold"), fg="gold",
                        bg=bg_color)
        F1.place(x=0, y=80, relwidth=1)

        cname_lbl = Label(F1, text="Customer Name", bg=bg_color, fg="White", font=("arial", 18, "bold")).grid(
        ...
        cphn_lbl = Label(F1, text="Contact No", bg=bg_color, fg="White", font=("arial", 18, "bold")).grid(
        ...
        F2 = LabelFrame(self.root, bd=8, text="fastfood", font=("arial", 15, "bold"), fg="black",
                        bg=bg_color)
        F2.place(x=5, y=180, width=325, height=380)

        bath_lbl = Label(F2, text="Burger", font=("arial", 16, "bold"), bg=bg_color, fg="green").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        bath_txt = Entry(F2, width=10, textvariable=self.Burger, font=("arial", 16, "bold"), bd=5,
                         relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10)

        Face_cream_lbl = Label(F2, text="Pizza", font=("arial", 16, "bold"), bg=bg_color,
                               fg="green").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        Face_cream_txt = Entry(F2, width=10, textvariable=self.Pizza, font=("arial", 16, "bold"), bd=5,
                               relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10)

        Fcae_w_lbl = Label(F2, text="French Fries", font=("arial", 16, "bold"), bg=bg_color,
                           fg="green").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        Face_w_txt = Entry(F2, width=10, textvariable=self.French_fries, font=("arial", 16, "bold"), bd=5,
                           relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10)

        Hair_s_lbl = Label(F2, text="Chicken chilly", font=("arial", 16, "bold"), bg=bg_color,
                           fg="green").grid(row=3, column=0, padx=10, pady=10, sticky="w")
        Hair_s_txt = Entry(F2, width=10, textvariable=self.Chicken_chilly, font=("arial", 16, "bold"), bd=5,
                           relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)

        Hair_g_lbl = Label(F2, text="Chowein", font=("arial", 16, "bold"), bg=bg_color,
                           fg="green").grid(row=4, column=0, padx=10, pady=10, sticky="w")
        Hair_g_txt = Entry(F2, width=10, textvariable=self.Chowein, font=("arial", 16, "bold"), bd=5,
                           relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)

        Body_lbl = Label(F2, text="Selroti", font=("arial", 16, "bold"), bg=bg_color,
                         fg="green").grid(row=5, column=0, padx=10, pady=10, sticky="w")
        Body_txt = Entry(F2, width=10, textvariable=self.Selroti, font=("arial", 16, "bold"), bd=5,
                         relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10)

        # ===================list2 Frame==========

        F3 = LabelFrame(self.root, bd=8, text="khajaset", font=("arial", 15, "bold"), fg="gold", bg=bg_color)
        ...
        Exit_btn = Button(btn_F, text="Exit", bg="cadetblue", fg="white", pady=15, bd=4,command=self.Exit_app,
    ...
    def clear_data(self):
        ...
        if op > 0:
            ...
            self.DalBhat.set(0)
            self.Newari_khaja.set(0)
            self.Thakali_food.set(0)
            self.Fish_curry.set(0)
